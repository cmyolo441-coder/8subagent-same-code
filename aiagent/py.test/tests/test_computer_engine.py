...
class EngineTests(unittest.TestCase):
    def setUp(self):
        ...
        self.root.mkdir()
        self.engines = []
        self.settings = Settings(api_adaptive=False, api_max_parallel=64, api_tokens_per_minute=0, hierarchy_enabled=False, plan_rounds=2, repair_rounds=1, token_budget=800000, request_timeout=5, work_steps=6, review_steps=3)
